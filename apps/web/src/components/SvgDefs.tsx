    ...
    <svg width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
      <defs>
        ...
        <symbol id="ico-semillas" viewBox="0 0 48 48">
          ...
          <g fill="currentColor">
            <ellipse cx="17" cy="19" rx="2.6" ry="3.4" transform="rotate(-18 17 19)" />
            <ellipse cx="24" cy="14" rx="2.6" ry="3.4" />
            <ellipse cx="31" cy="19" rx="2.6" ry="3.4" transform="rotate(18 31 19)" />
          </g>
        </symbol>
        ...
        <symbol id="ico-trato" viewBox="0 0 48 48">
          <g fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M38 22 h2 a4 4 0 0 1 4 4 v8 a4 4 0 0 1 -4 4 h-2 v5 l-6 -5 h-6" />
          </g>
          <g fill="currentColor">
            <circle cx="14" cy="17" r="1.9" /><circle cx="20" cy="17" r="1.9" /><circle cx="26" cy="17" r="1.9" />
          </g>
        </symbol>
        <symbol id="ico-origen" viewBox="0 0 48 48">
          <g fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <circle cx="35" cy="10" r="3.6" />
          </g>
        </symbol>
        <symbol id="ico-fresco" viewBox="0 0 48 48">
          <g fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            <path d="M24 42 V22" />
            <path d="M24 26 C 24 16, 16 10, 7 10 C 7 20, 14 26, 24 26 Z" />
            <path d="M24 22 C 24 14, 30 9, 41 9 C 41 17, 34 22, 24 22 Z" />
          </g>
        </symbol>
